...
setup(
    ...
    # 🔑 Pick up BOTH packages automatically
    packages=find_packages(exclude=("docs", "tests", "*.ipynb")),
    ...
    extras_require={
        "sidecar": ["flax>=0.7.0", "optax>=0.2.2"],
        "regrid": ["xesmf>=0.8.5"],
        "dev": ["pytest", "ruff", "black", "mypy"],
        "all": ["flax>=0.7.0", "optax>=0.2.2", "xesmf>=0.8.5"],
    },
    entry_points={
        "console_scripts": [
